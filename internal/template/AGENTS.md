...
anything disagrees with it.

This file is yours. ArchDoc creates it once and never rewrites it, so add whatever
project-specific instructions you like below. `archdoc agents` refreshes the `agents/`
directory only.
